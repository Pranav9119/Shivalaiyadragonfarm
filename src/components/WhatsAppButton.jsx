...
const WhatsAppButton = () => {
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="fixed bottom-24 right-4 md:bottom-28 md:right-8 z-50 flex items-center gap-3 px-6 py-4 bg-[#25D366] text-white rounded-full shadow-2xl hover:shadow-green-500/20 transition-all overflow-hidden group border-2 border-white/20"
        ...
        >
            ...
            <div className="relative">
                <div className="absolute inset-0 bg-white rounded-full scale-110 blur-sm opacity-20 group-hover:scale-150 transition-transform duration-500" />
                <svg
