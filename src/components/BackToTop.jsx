    ...
    return (
        <>
            {isVisible && (
                <button
                    onClick={scrollToTop}
                    className="fixed bottom-8 right-8 z-40 p-4 rounded-full bg-gradient-to-br from-dragon-pink to-dragon-pink-dark text-white shadow-2xl hover:shadow-dragon-pink/50 hover:scale-110 transition-all duration-300 group animate-fade-in-up"
